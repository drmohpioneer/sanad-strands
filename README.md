...
**Status: slices 00–09a accepted; slice 09b photos, amendments and record API implemented for review.** The package includes typed domain transitions, conditional memory/DynamoDB storage, fenced processing, recovery sweeps, a deterministic safety kernel, Telegram account/enrollment flows and an AWS development deployment. Doctor text, voice and photos produce editable confirmation cards in the configured worker. The full care workflow remains in development. This is the single active project folder.
